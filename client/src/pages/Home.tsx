        ...
        <div className="container relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <span className="block text-orange-500 mt-2">Inteligente e Completo</span>
            </h2>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Plataforma robusta desenvolvida para gerenciar manutenções de qualquer escala, com recursos avançados e interface intuitiva
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                descricao: "Crie, atribua e acompanhe ordens de serviço em tempo real com histórico completo"
              },
              {
                icon: "🔍",
                titulo: "Vistorias Detalhadas",
                descricao: "Realize vistorias completas com checklists personalizáveis e fotos de evidência"
              },
              {
                icon: "📊",
                titulo: "Relatórios Profissionais",
                descricao: "Gere relatórios customizados com gráficos, análises e métricas de desempenho"
              },
              {
                icon: "📱",
                titulo: "Aplicativo Mobile",
                descricao: "Acesse o sistema em qualquer lugar com app nativo para iOS e Android"
              },
              {
                icon: "🔐",
                titulo: "Segurança de Dados",
                descricao: "Criptografia de ponta a ponta e conformidade com LGPD e normas internacionais"
              },
              {
                icon: "🚀",
                titulo: "Integração Fácil",
                descricao: "Conecte com seus sistemas existentes através de APIs robustas e documentadas"
              }
            ].map((item, idx) => (
              <motion.div
                key={idx}
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-orange-500/50 hover:bg-white/10 transition-all duration-300"
              >
          ...
          <motion.div
            ...
            className="mt-20"
          >
            <h3 className="text-3xl font-bold text-white text-center mb-12">Planos Adaptados para Você</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  preco: "R$ 299",
                  periodo: "/mês",
                  descricao: "Para operações em larga escala",
                  features: [
                    "Até 5 usuários",
                    "Ordens de serviço ilimitadas",
                ...
                <motion.div
                  ...
                  className={`relative rounded-2xl overflow-hidden transition-all duration-300 ${
                    plano.destaque
                      ? "border-2 border-orange-500 bg-gradient-to-br from-orange-500/10 to-orange-500/5 scale-105 shadow-2xl shadow-orange-500/20"
                ...
                >
                  ...
                  <div className="p-8">
                    <h4 className="text-2xl font-bold text-white mb-2">{plano.nome}</h4>
                    <p className="text-gray-400 text-sm mb-6">{plano.descricao}</p>
                    
                    <div className="mb-6">
                      <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-bold text-orange-500">{plano.preco}</span>
                        <span className="text-gray-400">{plano.periodo}</span>
                      </div>
                      <p className="text-gray-400 text-sm mt-2">Até {plano.usuarios} usuário(s)</p>
                    </div>
          ...
          >
            <p className="text-gray-300 mb-6">Todos os planos incluem período de teste gratuito de 7 dias</p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer">
                <Button size="lg" variant="outline" className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white text-lg px-8">
